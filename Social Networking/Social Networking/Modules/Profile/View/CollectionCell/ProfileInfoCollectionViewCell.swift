...
protocol ProfileInfoCollectionViewCellDelegete: class {
    func didTap()
}

class ProfileInfoCollectionViewCell: UICollectionViewCell {
    
    weak var delegate: ProfileInfoCollectionViewCellDelegete?
    ...
    private lazy var buttonFullInfo: UIButton? = {
        ...
        button.setTitleColor(#colorLiteral(red: 0.9717823863, green: 0.9660050273, blue: 0.9762229323, alpha: 1), for: .normal)
    ...
    func userInformation(userData: UserProfile?)   {
        
        data = userData
        
        conteinerUserInformationView.addSubview(userAvatar)
        conteinerUserInformationView.addSubview(userFirstNameLabel)
        conteinerUserInformationView.addSubview(userLastNameLabel)
        ...
        userLastNameLabel.snp.makeConstraints { make in
            make.top.equalToSuperview().inset(35)
            make.leading.equalTo(userFirstNameLabel.snp.trailing).offset(5)
        }
        
        userInformationOnlineOrOffline.snp.makeConstraints { make in
            make.top.equalTo(userFirstNameLabel.snp.bottom).offset(5)
            make.leading.equalTo(userAvatar.snp.trailing).offset(10)
        }
        ...
        userFirstNameLabel.text = userData?.firstName
        userLastNameLabel.text = userData?.lastName
...
extension ProfileInfoCollectionViewCell: UICollectionViewDelegate {
    
}

//MARK: - UICollectionViewDataSource
extension ProfileInfoCollectionViewCell: UICollectionViewDataSource {
